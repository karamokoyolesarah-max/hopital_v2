        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-4">
                    <a href="http://127.0.0.1:8000/portal/dashboard" class="text-gray-600 hover:text-gray-900 transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm font-bold text-gray-900">PAT202604358</p>
                </div>
            </div>
