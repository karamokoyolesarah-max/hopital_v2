...
class SuperAdminController extends Controller
{
    ...
    // Resource-compatible wrapper methods expected by Route::apiResource
    ...
    {
        return $this->storeSubscriptionPlan($request);
    }

    public function update(Request $request, $id)
    {
        return $this->updateSubscriptionPlan($request, $id);
    }
